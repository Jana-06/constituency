        ...
        child: ListView(
          ...
          children: [
            ...
            asyncNews.when(
              ...
              error: (error, _) => Center(child: Text('Unable to load news: $error')),
              data: (articles) {
                ...
                final searched = searchQuery.isEmpty
                    ? filtered
                    : filtered.where((a) {
                        final haystack = '${a.title} ${a.description} ${a.source}'.toLowerCase();
                ...
                if (searched.isEmpty) {
                  return const Padding(
                    ...
                    child: Center(child: Text('No articles found for your filter/search.')),
                  );
                }

                return Column(
                  children: searched.map((article) {
                    return Card(
                      child: InkWell(
                        borderRadius: BorderRadius.circular(12),
                        onTap: () => context.push(
                          '/webview',
                          extra: {'title': article.source, 'url': article.url},
                        ),
                        child: Padding(
                          padding: const EdgeInsets.all(12),
                          child: Column(
